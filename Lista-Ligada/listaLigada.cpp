	...
	do
	{
		...
		switch (op)
		{
			...
			case '2': //inserir o primeiro nó
				...
				CABECA = novo;
				CAUDA = novo;
				break; //fim 2-inserir o primeiro nó
			...
			case '3': //inserir no fim o segundo nó
				...
				(*novo).proximo = NULL;
				CAUDA = novo;
				break; //fim 3-inserir no fim o segundo nó
			...
			case 'b': //inicializar com 3 nós
				...
				break; //fim b-inicializar com 3 nós
